...
client.login(token).catch(() => {
    ...
    console.log(` `);
    console.log(white('                               $$$$$$\ $$$$$$$$\ $$\     $$\ $$\       $$$$$$$$\  $$$$$$\        $$\   $$\ $$\   $$\ $$\   $$\ $$$$$$$$\ $$$$$$$\  '));
    console.log(white('                              $$  __$$\\__$$  __|\$$\   $$  |$$ |      $$  _____|$$  __$$\       $$$\  $$ |$$ |  $$ |$$ | $$  |$$  _____|$$  __$$\ '));
    console.log(blackBright('                              $$ /  \__|  $$ |    \$$\ $$  / $$ |      $$ |      $$ /  \__|      $$$$\ $$ |$$ |  $$ |$$ |$$  / $$ |      $$ |  $$ |'));
    console.log(blackBright('                              \$$$$$$\    $$ |     \$$$$  /  $$ |      $$$$$\    \$$$$$$\        $$ $$\$$ |$$ |  $$ |$$$$$  /  $$$$$\    $$$$$$$  |'));
    console.log(magentaBright('                               \____$$\   $$ |      \$$  /   $$ |      $$  __|    \____$$\       $$ \$$$$ |$$ |  $$ |$$  $$<   $$  __|   $$  __$$< '));
    console.log(magentaBright('                              $$\   $$ |  $$ |       $$ |    $$ |      $$ |      $$\   $$ |      $$ |\$$$ |$$ |  $$ |$$ |\$$\  $$ |      $$ |  $$ |'));
    console.log(magentaBright('                              \$$$$$$  |  $$ |       $$ |    $$$$$$$$\ $$$$$$$$\ \$$$$$$  |      $$ | \$$ |\$$$$$$  |$$ | \$$\ $$$$$$$$\ $$ |  $$ |'));
    console.log(magentaBright('                               \______/   \__|       \__|    \________|\________| \______/       \__|  \__| \______/ \__|  \__|\________|\__|  \__|'));
	console.log(` `);
